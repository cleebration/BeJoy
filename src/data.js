...
export const sidebarPosts = [
  { id: 2,  de: "Der Atem als Reset-Knopf", en: "The breath as a reset button", es: "La respiración como botón de reinicio" },
  { id: 6,  de: "Resilienz ist kein Panzer", en: "Resilience is not armor", es: "La resiliencia no es una armadura" },
  { id: 8,  de: "Ikigai: der Grund aufzustehen", en: "Ikigai: the reason to get up", es: "Ikigai: la razón para levantarse" },
  { id: 12, de: "Kreativität als menschlicher Kern", en: "Creativity as the human core", es: "La creatividad como núcleo humano" }
];
